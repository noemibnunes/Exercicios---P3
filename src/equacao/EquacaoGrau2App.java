...
public class EquacaoGrau2App {
	...
	public static void main(String[] args) {
		...
		switch (qtd) {
			case 0:
				System.out.println("a: " + a + ", b: " + b + ", c: " +c + ", delta: " + delta + ", e quantidade: " + qtd);
				break;
			case 1:
				double r1 = equacao.getRaiz1();
				System.out.println("a: " + a + ", b: " + b + ", c: " +c + ", delta: " + delta + ", quantidade: " + qtd + ", x' = " + r1);
				break;
			case 2:
				double x1 = equacao.getRaiz1();
				double x2 = equacao.getRaiz2();
				System.out.println("a: " + a + ", b: " + b + ", c: " +c + ", delta: " + delta + ", quantidade: " + qtd + ", x' = " + x1 + " e x'' = " + x2);
				break;
		}
